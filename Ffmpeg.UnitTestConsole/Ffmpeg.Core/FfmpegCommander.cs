...
"vdslice"};
        ...
        public FfmpegCommander WithInputFile(string filePath, decimal inputDuration)
        {
            InputFile = filePath;
        ...
        public FfmpegCommander WithOutDuration(decimal duration)
        {
            OutputDuration = duration;
            return this;
        }
        public FfmpegCommander WithScale(int width, int height)
        {
            Width = width;
            Height = height;
            return this;
        }
        public FfmpegCommander WithOutput(string fileOutput)
        {
        ...
        public FfmpegCommander WithFileOverlay(string fileOverlay, decimal fromSeconds, decimal duration, string scale, decimal posX, decimal posY, int borderSize = 0, string borderColor = "black")
        {
        ...
        public FfmpegCommander WithTextOverlay(string overlayText, string overlayTextColor = "white", decimal posX = 0, decimal posY = 0, int overlayFontSize = 24, bool overlayTextAllowBg = true, string overlayTextBgColor = "black", string overlayFontFilePath = "")
        {
            _overlayPosX = posX;
            _overlayPosY = posY;
        ...
        string _audioFile;
        public FfmpegCommander WithAudio(string audioFile)
        {
        ...
        /// <returns></returns>
        public FfmpegCommander WithTransitionNext(string fileVideoNext, decimal fadeFileDuration, int fadeDuration, string fadeMode="")
        {
